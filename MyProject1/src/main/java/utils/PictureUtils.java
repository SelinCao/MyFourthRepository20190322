...
public class PictureUtils {
    public static final String url = "http://" + PropertyTest.getProperties().getProperty("faceUrlSingle")
            + ":9001/verify/feature/gets";
//    public static final String url = "http://10.45.144.94:9001/verify/feature/gets";
    ...
    public static String httpExecute(File file, String url) {
        String res = "";
        try {
            CloseableHttpClient client = HttpClients.createDefault();
            HttpPost httpPost = new HttpPost(url);
