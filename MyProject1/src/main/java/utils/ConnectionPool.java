...
public class ConnectionPool {
    ...
    // 连接池的初始大小
    private int initialConnections = 10;//ConfigManager.getInt(Constant.SDK_CONNECTION_INITIAL_SIZE);
    // 连接池自动增加的大小
    private int incrementalConnections = 5;
    // 连接池最大的大小
    private int maxConnections = 100;//ConfigManager.getInt(Constant.SDK_CONNECTION_MAX_SIZE);
